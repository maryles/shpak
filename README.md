...
<html>
    ...
    <body style="background-color:#DAA520">
        <header> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtao_JQThtqYcCbUJqqa6R1s_GyQ69Dj1-QQ&usqp=CAU" width="50px"height="50px">  
        </header>
           <h1 style="color:#000000;text-align:center;font-family: gabriola"> 
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRefOz59BCtGXXNbThPpWgbaJDdabrVhzgYBA&usqp=CAU"width="607px"height="350px">
          </h1>
